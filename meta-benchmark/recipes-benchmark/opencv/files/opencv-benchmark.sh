...
--mean="104 117 123" --rgb --counter=$MAX_RUN_COUNT
...
--scale="0.004" --mean="104 117 123" --rgb --counter=$MAX_RUN_COUNT
...
--input=/usr/bin/opencvBenchmark/grace_hopper.jpg --mean="104 117 123" --rgb --counter=$MAX_RUN_COUNT
...
--input=/usr/bin/opencvBenchmark/grace_hopper.jpg --scale="0.004" --mean="0 0 0" --rgb --counter=$MAX_RUN_COUNT
...
--input=/usr/bin/opencvBenchmark/grace_hopper.jpg --mean="0 0 0" --scale="0.004" --rgb --counter=$MAX_RUN_COUNT
...
--mean="0 0 0" --scale="0.004" --rgb --counter=$MAX_RUN_COUNT
