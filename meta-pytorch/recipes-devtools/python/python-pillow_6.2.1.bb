# Recipe from:
# http://git.yoctoproject.org/cgit/cgit.cgi/meta-maker/tree/recipes-python/pillow/python-pillow_5.0.0.bb?h=rocko
...
SRC_URI = " \
	git://github.com/python-pillow/Pillow;protocol=https \
