...
/usr/bin/opencvBenchmark/opencv-dnn-benchmark --model=/home/root/models/opencv/squeezenet1.1.onnx --width=224 --height=224 \
...
/usr/bin/opencvBenchmark/opencv-dnn-benchmark --model=/home/root/models/opencv/mobilenetv2-1.0.onnx --width=224 --height=224 \
...
/usr/bin/opencvBenchmark/opencv-dnn-benchmark --model=/home/root/models/opencv/squeezenet_v1.1.caffemodel \
...
/usr/bin/opencvBenchmark/opencv-dnn-benchmark --model=/home/root/models/opencv/inception_v3_2016_08_28_frozen.pb \
...
/usr/bin/opencvBenchmark/opencv-dnn-benchmark --model=/home/root/models/opencv/darknet19.weights \
...
/usr/bin/opencvBenchmark/opencv-dnn-benchmark --model=/home/root/models/opencv/darknet.weights \
